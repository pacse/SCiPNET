...
"""Hex colour codes used in rendering"""
...
# To display an SCP
def acs_bar(scp_info: temp, console: Console) -> None:
    '''
...
# To display a site
def site_bar(site_info: temp, site_loc: str, console: Console) -> None:
    print()
    printc(f"╔{REPEATED}═{REPEATED}╗")
...
# To display a MTF
def mtf_bar(mtf_info: temp, console: Console) -> None:
    print()
    printc(f"╔{REPEATED}═{REPEATED}╗")
...
# to display a user
def user_bar(user_info: temp, console: Console) -> None:
    print()
    printc(f"╔{REPEATED}═{REPEATED}╗")
